...
const botadi = "Moderasyon"

exports.run = async (bot, msg, args) => {

        let simdikitarih = moment.utc(msg.createdAt).format('DD MM YYYY');
  if(!msg.member.roles.has("683426904732336155")) return msg.channel.send(`Bu komutu kullanabilmek için \`Kayıt Sorumlusu\` yetkisine sahip olmasınız.`);
